...
class VinylsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vinyl" do
    assert_difference('Vinyl.count') do
      post vinyls_url, params: { vinyl: { artist: @vinyl.artist, notes: @vinyl.notes, title: @vinyl.title } }
    end
  ...
  test "should update vinyl" do
    patch vinyl_url(@vinyl), params: { vinyl: { artist: @vinyl.artist, notes: @vinyl.notes, title: @vinyl.title } }
